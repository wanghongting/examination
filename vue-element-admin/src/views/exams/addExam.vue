        ...
        <el-form-item label="选择考试类型" prop="exam_id">
          <el-col :span="10">
            <el-select v-model="ruleForm.exam_id" placeholder="选择考试类型" size="large">
              <el-option v-for="item in examlist.data" :key="item.exam_id" :label="item.exam_name" :value="item.exam_id" />
            </el-select>
          </el-col>
        </el-form-item>
        <el-form-item label="选择课程" prop="subject_id">
          <el-col :span="10">
            <el-select v-model="ruleForm.subject_id" placeholder="选择课程" size="large">
              <el-option v-for="item in subjectlist.data" :key="item.subject_id" :label="item.subject_text" :value="item.subject_id" />
            </el-select>
          </el-col>
        </el-form-item>
